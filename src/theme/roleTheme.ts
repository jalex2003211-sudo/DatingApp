...
const themeTokens: Record<'male' | 'female' | 'neutral', RoleThemeTokens> = {
  male: {
    accent: '#93C5FD',
    heart: '#60A5FA',
    chipBg: 'rgba(147,197,253,0.10)',
    borderGlow: 'rgba(147,197,253,0.22)'
  },
  female: {
    accent: '#FBCFE8',
    heart: '#F472B6',
    chipBg: 'rgba(251,207,232,0.10)',
    borderGlow: 'rgba(244,114,182,0.22)'
  },
  neutral: {
    accent: '#C7D2FE',
    heart: '#A5B4FC',
    chipBg: 'rgba(199,210,254,0.10)',
    borderGlow: 'rgba(165,180,252,0.22)'
  }
};
